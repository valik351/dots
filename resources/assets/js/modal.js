        ...
        $(document).ready(function () {
            ...
            var TIME_FORMAT_INTERNAL = 'YYYY-MM-DD HH:mm:ss',
                ...
                CONFIRM_TEMPLATE = '<div class="modal fade {class}">'
                    ...
                    + '<div class="btn-group">'
                    + '<a class="btn btn-primary {btnCancelClass}" data-dismiss="modal" style="margin-bottom:0px;" href="javascript:void(0);"><span class="fa fa-angle-left"></span> {btnCancelLabel}</a>'
